 ...
 */
@Component
public class PostGeishaById extends BaseRestRouteBuilder {
	...
	public void configure() throws Exception {
		...
		from(direct("post-geisha-id-impl"))
			.routeId("direct:post-geisha-id-impl")
			/** Pick K/V pairs from JSON incoming body */
            .setProperty("rarity", datasonnetEx("payload.rarity", Integer.class))
         
            .doTry()
	            /** Call Stored Procedure */
	            .to(sqlStored(SQLPATH+"create_geisha.sql"))
            ...
            .doCatch(SQLException.class)
            	...
            	.throwException(
        			new InternalServerException(
    					throwServerError(
							"The Geisha could not be uploaded to the database. Please try again and if the problem persists please contact an admin at admin@aaronrenner.com",
