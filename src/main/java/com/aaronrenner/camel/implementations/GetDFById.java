 ...
 */
@Component
public class GetDFById extends BaseRestRouteBuilder {
	...
	public void configure() throws Exception {
		...
		from(direct("get-df-id-impl"))
			.routeId("direct:get-df-id-impl")
            .doTry()
	            /** Send SQL call */
	            .to(sqlStored(SQLPATH+"get_deadfellaz_by_id.sql"))
	            /** Validate response was returned or throw 404 */
	            .to(direct("validate-sql-get-operation"))
	            /** format response */
	            .transform(datasonnetEx(DSPATH+"getDeadfellazByIdResponse.ds", String.class)
